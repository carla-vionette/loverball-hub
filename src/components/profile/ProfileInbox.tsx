    ...
    >
      <Tabs defaultValue="notifications">
        ...
        <TabsContent value="notifications" className="mt-2">
          {loading ? (
            <div className="px-3 py-3 text-center text-[13px]" style={{ color: "rgba(250,245,233,0.55)" }}>Loading…</div>
          ...
          {previewNotifs.length > 0 && unreadNotifs > 0 && (
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2 text-[10px] uppercase transition-colors hover:bg-white/[0.03]"
