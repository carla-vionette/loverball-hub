...
const TEAM_GAME_SCHEDULE: Record<string, UpcomingGame> = {
  ...
  angels: { home: "Angels", away: "Texas Rangers", date: "Apr 11", time: "6:38 PM", channel: "Apple TV+", channelBg: "bg-gray-800", channelText: "text-white", url: "https://tv.apple.com", sport: "MLB" },
  ...
  galaxy: { home: "LA Galaxy", away: "Austin FC", date: "Apr 19", time: "7:30 PM", channel: "Apple TV+", channelBg: "bg-gray-800", channelText: "text-white", url: "https://tv.apple.com/us/mls-season-pass", sport: "MLS" },
  lafc: { home: "LAFC", away: "Portland Timbers", date: "Apr 20", time: "7:30 PM", channel: "Apple TV+", channelBg: "bg-gray-800", channelText: "text-white", url: "https://tv.apple.com/us/mls-season-pass", sport: "MLS" },
