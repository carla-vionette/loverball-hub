...
export const TEAM_PERFORMANCE = [
  {
    ...
    nextGame: "@ Miami · Mar 19",
    league: "NBA",
    leadingScorer: "Luka Dončić – 35.2 PPG",
    injuryNote: null,
  ...
  },
  {
    ...
    winPct: 0,
    last5: [],
    nextGame: "vs D-backs · Mar 26 (Opening Day)",
    league: "MLB",
  ...
  },
  {
    ...
    nextGame: "@ Austin FC · Mar 21",
    league: "MLS",
    leadingScorer: "Denis Bouanga – 4 Goals",
    injuryNote: null,
  ...
  },
  {
    ...
    winPct: 1.0,
    last5: [true],
    nextGame: "@ Bay FC · Mar 21",
    league: "NWSL",
    leadingScorer: "Season just started",
    injuryNote: null,
