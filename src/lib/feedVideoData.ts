...
export const FEED_VIDEOS: FeedVideoItem[] = [
  {
    ...
    description: "The art of the pitch. AI-generated beauty meets the beautiful game.",
    duration: 30,
    likes: 12400,
    views: 245000,
    uploadDate: "2026-02-16",
    tags: ["soccer", "sora", "cinematic"],
    isFollowing: true,
  },
  {
    id: "sora_tennis",
  ...
  },
  {
    ...
    description: "Where gravity meets grace. AI-powered hoops cinema.",
    duration: 32,
    likes: 15200,
    views: 312000,
    uploadDate: "2026-02-16",
    tags: ["basketball", "sora", "cinematic"],
    isFollowing: true,
  },
  {
    id: "sora_sport_4",
