...
export const FEED_VIDEOS: FeedVideoItem[] = [
  ...
  },
  {
    ...
    title: "Play Me — The Rematch 🎯",
    description: "When the competition gets personal. Who's taking the W?",
    duration: 36,
    likes: 7800,
    views: 142000,
    uploadDate: "2026-02-04",
    tags: ["basketball", "competition", "1v1"],
  },
  {
    id: "feed_011",
    channelId: "fan-life",
  ...
  },
  {
    ...
    videoUrl: feedVideo5,
    thumbnail: teamSpiritThumb,
    title: "Behind the Scenes — Fan Life Unfiltered",
    description: "What game day really looks like through the fans' eyes.",
    duration: 28,
    likes: 3400,
    views: 67000,
