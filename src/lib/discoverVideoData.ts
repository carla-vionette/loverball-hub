...
export const DISCOVER_VIDEOS: DiscoverVideo[] = [
  // Basketball
  { id: "dv1", title: "Top 10 WNBA Plays This Week", channel: "Loverball Originals", category: "Basketball", views: 24100, likes: 3200, duration: "2:45", gradient: "from-primary to-primary/70", thumbnail: "", videoUrl: feedVideo29, addedDate: "2026-03-08", trending: true },
  { id: "dv2", title: "Courtside Breakdown: Lakers vs Clippers", channel: "CourtSide Queens", category: "Basketball", views: 31400, likes: 4100, duration: "4:20", gradient: "from-accent to-accent/60", thumbnail: "", videoUrl: feedVideo31, addedDate: "2026-03-07", trending: true },
  ...
  // Soccer
  { id: "dv4", title: "Angel City FC Match Highlights", channel: "ACFC Media", category: "Soccer", views: 18300, likes: 2800, duration: "3:12", gradient: "from-accent to-accent/70", thumbnail: "", videoUrl: feedVideo30, addedDate: "2026-03-08", trending: true },
  { id: "dv5", title: "Soccer Skills Challenge", channel: "Soccer Sisters", category: "Soccer", views: 15400, likes: 1900, duration: "2:30", gradient: "from-accent to-primary/60", thumbnail: "", videoUrl: feedVideo36, addedDate: "2026-03-05" },
  ...
  // Culture
  { id: "dv11", title: "LA28 Olympic Venue Tour", channel: "Olympic Dreams", category: "Culture", views: 9800, likes: 1400, duration: "6:30", gradient: "from-accent/80 to-primary/60", thumbnail: "", videoUrl: feedVideo35, addedDate: "2026-03-06" },
  ...
  // Lifestyle
  { id: "dv13", title: "Game Day Outfit Inspo 🔥", channel: "Game Day Girls", category: "Lifestyle", views: 12700, likes: 2100, duration: "1:30", gradient: "from-primary/80 to-primary/40", thumbnail: "", addedDate: "2026-03-07" },
  { id: "dv14", title: "Tailgate Cooking: Stadium Style 🌭", channel: "Game Day Girls", category: "Lifestyle", views: 8900, likes: 980, duration: "2:00", gradient: "from-accent/60 to-primary/40", thumbnail: "", addedDate: "2026-03-05" },
