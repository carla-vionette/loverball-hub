...
const plans = [
  {
    ...
    price: '$0',
    period: '/month',
    description: 'Ad-supported content & limited features',
    features: [
  ...
  },
  {
    ...
    price: '$15',
    period: '/month',
    description: 'Full digital community experience',
    features: [
      'No ads',
      'Full content library',
      'Full digital community',
      'Priority RSVPs',
      'Invite tracking',
    ],
    cta: 'Get All Access',
  ...
  },
  {
    ...
    price: '$35',
    period: '/month',
    description: 'Everything in All Access plus IRL perks',
    features: [
