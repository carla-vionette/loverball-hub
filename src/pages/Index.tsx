...
const Index = () => {
  ...
  const scrollToMemberAccess = () => {
    document.getElementById('member-access')?.scrollIntoView({
      behavior: 'smooth'
    });
  };
  return <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center gap-3">
              <button onClick={() => isAuthenticated ? navigate("/events") : scrollToMemberAccess()} className="px-5 py-2 text-sm font-medium text-foreground/70 hover:text-foreground hover:bg-secondary rounded-full transition-all bg-transparent border-none cursor-pointer">
                Events
              </button>
      ...
      <div className="bg-primary text-primary-foreground py-4 overflow-hidden">
        ...
        ease: "linear"
          ...
          {[...Array(10)].map((_, i) => <span key={i} className="flex items-center gap-12 text-sm tracking-widest font-medium">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-0 items-center">
            ...
            once: true
              ...
              <Button onClick={scrollToMemberAccess} size="lg" className="rounded-full bg-primary hover:bg-primary/90 px-10 py-6 text-base font-medium">
                Get Access
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </motion.div>
      ...
      {!isAuthenticated && <section id="member-access" className="py-24 lg:py-32 bg-background">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
                ...
                <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] border border-border/50">
                  <Tabs defaultValue="login" className="w-full">
                    ...
                    <TabsContent value="login">
                      {showForgotPassword ? <form onSubmit={handleForgotPassword} className="space-y-6 mt-8">
                          ...
                          <Button type="submit" className="w-full rounded-full h-12 text-sm font-medium" disabled={loading}>
                            {loading ? "Sending..." : "Send Reset Link"}
                          </Button>
                          <button type="button" onClick={() => setShowForgotPassword(false)} className="w-full text-sm text-primary hover:text-primary/80 transition-colors font-medium">
                            Back to sign in
                          </button>
                        </form> : <form onSubmit={handleLogin} className="space-y-6 mt-8">
                          <div className="space-y-2">
