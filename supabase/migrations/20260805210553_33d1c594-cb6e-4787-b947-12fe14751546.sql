CREATE OR REPLACE FUNCTION public.get_fan_matches(_user_id uuid, _limit integer DEFAULT 12)
RETURNS TABLE(id uuid, name text, city text, bio text, profile_photo_url text, favorite_la_teams text[], favorite_sports text[], match_score integer, reasons text[])
LANGUAGE plpgsql
STABLE
SECURITY DEFINER
